...
coverage: ## check code coverage quickly with the default Python
	coverage run --source chibi_dl_elasticsearch setup.py test
	coverage report -m
	coverage html
	$(BROWSER) coverage_html_report/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/chibi_dl_elasticsearch.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ chibi_dl_elasticsearch
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
pep8:
	...
	@pep8 --statistics chibi_dl_elasticsearch tests

flakes:
	@echo "Running flakes tests..."
	@pyflakes chibi_dl_elasticsearch tests
